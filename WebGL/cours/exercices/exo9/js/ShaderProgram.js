...
ShaderProgram.prototype.init = function(ctx, vertexShaderSrcURL, pixelShaderSrcURL)
{
	...
	var fragmentShader 	= this.getShader(pixelShaderSrcURL, this._ctx.FRAGMENT_SHADER);
	var vertexShader 	= this.getShader(vertexShaderSrcURL, this._ctx.VERTEX_SHADER);
	...
	this.vertexNormalAttribute = this._ctx.getAttribLocation(this._program, "aVertexNormal");
	this._ctx.enableVertexAttribArray(this.vertexNormalAttribute);
	...
	this.normalMatrixUniform 	= this._ctx.getUniformLocation(this._program, "normalMatrix");
	this.uSamplerUniform 		= this._ctx.getUniformLocation(this._program, "uSampler");
	this.lightDirectionUniform 	= this._ctx.getUniformLocation(this._program, "lightDirection");
	this.lightColorUniform 		= this._ctx.getUniformLocation(this._program, "lightColor");
	this.ambiantColorUniform 	= this._ctx.getUniformLocation(this._program, "ambiantColor");
};
