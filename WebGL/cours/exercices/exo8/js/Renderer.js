...
Renderer.prototype._ambiantColor	= [0.05,0.05,0.05];
...
{
	var distA = Utils.distanceFromCamera(meshA, this._camera);
	var distB = Utils.distanceFromCamera(meshB, this._camera);
