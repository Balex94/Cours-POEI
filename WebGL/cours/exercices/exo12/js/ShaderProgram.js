...
ShaderProgram.prototype.alphaUniform 			= null;
ShaderProgram.prototype.shininessUniform 		= null;
...
ShaderProgram.prototype.useProgram	= function(ctx)
{
...
ShaderProgram.prototype.reset		= function(ctx)
{
	...
	this.alphaUniform 			= ctx.getUniformLocation(this._program, "uAlpha");
	...
	this.shininessUniform 		= ctx.getUniformLocation(this._program, "uShininess");
	this.specularColorUniform 	= ctx.getUniformLocation(this._program, "specularColor");
};
